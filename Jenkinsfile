pipeline {
    ...
    stages {
        ...
        stage('Ansible Deploy') {
             steps {
           sh 'scp -i /home/gbarnacle79/.ssh/id_rsa /home/gbarnacle79/week9/docker-compose.yaml manager:'
           sh 'scp -i /home/gbarnacle79/.ssh/id_rsa /home/gbarnacle79/week9/nginx.conf manager:'
